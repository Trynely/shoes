...
const Wishlist = () => {
    ...
    const wishlistThingsDelete = async (id) => {
        try {
            const response = await fetch(`http://127.0.0.1:8000/delete-from-wishlist/${id}/`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + String(tokens.access)
    ...
    const wishlistClear = async () => {
        try {
            const response = await fetch('http://127.0.0.1:8000/clear-wishlist/', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + String(tokens.access)

...
import "./header.css"
import { CartLengthContext } from "../items-length/CartWishlistLen"

const Header = () => {
    const {user, setTokens, setUser} = useContext(AuthenticationContext)
    const thingsOfCart = useContext(CartLengthContext)
            ...
            <div className='header__container'>
                ...
                <div className='container__nav'>
                    ...
                    <NavLink to="/cart" className={({isActive}) => isActive ? activeLink : normaLink} style={{position: 'relative'}}>
                        <span className="cart_len">{thingsOfCart.length}</span>
                        ...
                        <div style={user ? null : {transform: "none", padding: "0", background: "transparent"}} className="user_container__is_authenticated">
                            {
                                user ?
                                    <div className="is_authenticated__user_options">
                                        ...
                                        <svg className="bottom_user_arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor">
